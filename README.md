...
Network & Information Security Analyst, working at the intersection of **networking, security, and automation**.

Professional experience with:
- DDoS detection and mitigation
- Traffic analysis (BGP, TCP/IP, Flow)
- Network and security automation (Python, SSH)
- Observability (Grafana, Zabbix, Elastic)

Currently building skills in **offensive security** (Web Security / Bug Bounty) and **Detection Engineering**.
...
`Python` `Flask` `PostgreSQL` `Linux` `Nginx` `SQL` `Paramiko`
